const profileData_EN = {
  ...
  about: {
    ...
    intro_short: `Ambitious and Innovative Software Architect with Professional Experience in
    App. development and ABAP (SAP). Passionate about New Technologies and Digital Transformation.`,
    intro: `Dynamic and forward-thinking Software Architect with a proven track record in both application development and ABAP (SAP). 
      Adept at translating ambitious ideas into innovative solutions, I am deeply passionate about staying at the forefront of new technologies 
      and driving digital transformation. My professional experience is marked by a commitment to excellence, ensuring the seamless integration of 
